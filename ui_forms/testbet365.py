...
class Bet365:
    ...
    def parser_data(self):
        ...
        try:
            ...
            table = soup.find('div', {'class': 'card-content card-content-padding'}) ##classe onde se encontram as informações##
            self.tr_element = table.find_all('div',{'class':'event-body'})
        except Exception as e:
            print('Houve um erro inesperado:  '+ e)
            pass
