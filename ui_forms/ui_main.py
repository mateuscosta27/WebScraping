...
"")
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.frame_options)
        ...
        self.gridLayout_5 = QtWidgets.QGridLayout(self.frame_btn_options)
...
"}")
        ...
        self.frame_side_options.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_side_options.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_side_options.setObjectName("frame_side_options")
        self.gridLayout = QtWidgets.QGridLayout(self.frame_side_options)
...
"font: 75 10pt \"MS Shell Dlg 2\";")
        ...
        self.cb_filter_odds_2 = QtWidgets.QComboBox(self.frame_side_options)
        self.cb_filter_odds_2.setMinimumSize(QtCore.QSize(150, 30))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(9)
        self.cb_filter_odds_2.setFont(font)
        self.cb_filter_odds_2.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"font: 75 10pt \"MS Shell Dlg 2\";")
        self.cb_filter_odds_2.setObjectName("cb_filter_odds_2")
...
"")
    ...
    def retranslateUi(self, Main):
        ...
        self.cb_filter_odds_2.setItemText(0, _translate("Main", "Dados Pixbet"))
        self.cb_filter_odds_2.setItemText(1, _translate("Main", "Dados Betano"))
